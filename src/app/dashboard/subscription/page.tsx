...
// Static tier definitions (you can move this to a separate file)
const staticTiers = [
  {
    name: "Free",
    price: 0,
        ...
        {tier.name !== "Free" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Contact support to change your plan or manage your subscription.
              </CardDescription>
            </CardHeader>
          </Card>
        )}
...
function PricingCard({
  ...
  canCustomizeBanner,
  currentTierName,
}: typeof staticTiers[number] & { currentTierName: string }) {
